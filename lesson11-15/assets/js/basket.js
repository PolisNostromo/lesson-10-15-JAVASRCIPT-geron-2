...
cart.forEach(cart => {
    ...
    <div class="column" id="third">
        <div class="counter">
            <input type="button" value="-" class="btn minus" onclick='CounterChangeMinus()'>
            <p class="quantity">1</p>
            <input type="button" value="+" class="btn plus" onclick='CounterChangePlus()'>
        </div>
    </div>
...
function changePrice(change = 0){
    ...
    let totalupdate_html = document.querySelector('.product #fourth p')
...
const CounterChangePlus = () =>{
    let counter_html = document.querySelector('.quantity')
    let quantity = counter_html.innerHTML
...
const Total = () => {
    let totalupdate_html = document.querySelectorAll('.product #fourth p')
    let total = totalupdate_html.innerHTML
    let price_html = document.querySelector('.product #second p')
    let price = price_html.innerHTML
    price = price.replace('$','')
    price = parseFloat(price)
    ...
    let new_total = total (price * quantity)
    totalupdate_html.innerHTML = new_total + '$'
}
